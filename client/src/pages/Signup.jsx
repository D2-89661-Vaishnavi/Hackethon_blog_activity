...
function Signup() {
  ...
  const registerUser = async (fullname, email, password, phone) => {
    ...
    console.log("Would register user with:", { fullname, email, password, phone });
            ...
            <div className="col-12 col-md-9 col-lg-7 col-xl-6 col-xxl-5">
              <div className="card border border-light-subtle rounded-4">
                <div className="card-body p-3 p-md-4 p-xl-5">
                  ...
                  <form action="#!" onSubmit={(e) => { e.preventDefault(); onRegister(); }}>
                    <div className="row gy-3 overflow-hidden">
                      ...
                      <div className="col-12">
                        <div className="form-floating mb-3">
                          <input 
                            ...
                            required
                          />
                          <label htmlFor="phone" className="form-label">Phone_no</label>
                        </div>
                      </div>
                      <div className="col-12">
                      ...
                      <div className="col-12">
                        <div className="d-grid">
                          <button type="submit" className="btn bsb-btn-xl btn-primary">Sign up</button>
                        </div>
                      </div>
                    </div>
                  </form>
